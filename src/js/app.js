!function (o) {
    ...
    t.prototype.initprofileRipple = function () {
        o("#profile_ripple").ripples({resolution: 512, dropRadius: 20, perturbance: .04})
        ...
        o(window).scroll(function () {
            ...
            0 == i && o(window).scrollTop() > t && (o(".counter-value").each(function () {
                var t = o(this), i = t.attr("data-count");
                o({countNum: t.text()}).animate({countNum: i}, {
        ...
        o(window).on("load", function () {
            var i = o(".projects-wrapper"), n = o("#filter");
            i.isotope({
                filter: "*",
                layoutMode: "masonry",
